...
class SearchDepartmentScreen extends StatefulWidget {
  @override
  _SearchDepartmentScreenState createState() => _SearchDepartmentScreenState();
}

class _SearchDepartmentScreenState extends State<SearchDepartmentScreen> {
        ...
        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
          if (!snapshot.hasData) {
            ...
            List<DocumentSnapshot> filteredDocs = snapshot.data!.docs.where((doc) =>
                doc.get("email").toLowerCase().contains(_searchText)
            ).toList();
